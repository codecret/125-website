...
const Hero = ({ toggleTheme, dark, refVar }) => {
  ...
  return (
    ...
    >
      {/* 0b1591 */}
      <motion.div className="relative w-full h-[70vh] sm:h-[80vh] m-0 md:m-auto md:h-[calc(100vh-150px)] overflow-hidden bg-primary rounded-[20px] md:rounded-[40px] md:rounded-b-[60px] backgroundblue">
        <div
        ...
        <div className="relative w-full h-full flex justify-center items-center px-5 md:px-2">
          <p className="px-3 sm:px-5 quotes font-extrabold tracking-normal quote md:leading-normal text-2xl sm:text-[2.5rem] md:text-5xl text-white md:max-w-3xl text-center md:px-16 ">
