...
const Hero = ({ toggleTheme, dark, refVar }) => {
  ...
  return (
    ...
    >
      {/* 0b1591 */}
      <motion.div className="relative w-full h-screen m-0 md:m-auto md:h-[calc(100vh-150px)] flex flex-col justify-center items-center overflow-hidden bg-primary rounded-[20px] md:rounded-[40px] md:rounded-b-[60px] backgroundblue">
        <div
        ...
        <div className="relative w-full h-full flex justify-center items-center rounded-[40px] px-5 md:px-2">
          <p className="px-5 quotes font-extrabold tracking-normal quote md:leading-normal text-[2rem] md:text-5xl text-white md:-translate-y-[50%] md:max-w-screen-md text-center md:px-16 ">
