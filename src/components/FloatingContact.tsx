...
const WHATSAPP_NUMBER = "0561231217";
const PHONE_NUMBER = "+966561231217";
  ...
  return (
    <div className="fixed bottom-6 right-6 z-50 flex flex-col items-end gap-3">
      ...
      <button
        ...
        className={`w-14 h-14 bg-primary hover:bg-primary/90 rounded-full flex items-center justify-center shadow-lg transition-all duration-300 ${
          open ? "rotate-45" : ""
        }`}
      >
        {open ? (
